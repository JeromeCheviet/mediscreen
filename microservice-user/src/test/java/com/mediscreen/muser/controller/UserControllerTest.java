...
public class UserControllerTest {
    ...
    @Sql(scripts = "/delete_data.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    @Test
    void test_getUser_mustReturnIsOk() throws Exception {
    ...
    @Test
    void test_getUser_mustReturnNotFound_whenTableIsEmpty() throws Exception {
        mvc.perform(get("/v1/user/1"))
                .andDo(print())
                .andExpect(status().isNotFound())
                .andExpect(status().reason("User not found"));
    ...
    @Sql(scripts = "/delete_data.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
    @Test
    void test_getUser_mustReturnNotFound_whenUserNotExist() throws Exception {
